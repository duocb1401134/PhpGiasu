...
if (isset($_COOKIE['ID_GS'])) {
    ...
    $tutor = new Tutor();
    $login = $tutor->select_once_tutor($_COOKIE['ID_GS']);
    $_SESSION['ID_GS'] = $login['ID_GS'];
...
<html>
    ...
    <body onload="startTime()">
        ...
        <div class="events" id="loingo" style="padding-left: 100px; padding-right: 100px;">
            <h3>Lời ngõ</h3>
            <p>
                Lời đầu tiên cho trung tâm gia sư giỏi 123 gởi lời cảm ơn chân thành và sâu sắc đến các thầy cô luôn đồng hành cùng trung tâm, các phụ huynh cùng các em học sinh thân mến.</p>
            <p>
                Được sự động viên chân thành và đóng góp ý kiến xây dựng của tất cả bạn bè, đồng nghiệp mà trung tâm gia sư giỏi 123 đã hoàn thành xuất sắc nhiệm vụ giáo dục con người của mình. Để đáp lại tình cảm tốt đẹp đó trung tâm cố gắng phát huy tất cả nguồn lực
                để phục vụ công tác giáo dục một cách tốt nhất.</p>
            <p>
                Quý phụ huynh cùng các em học sinh đã quen với trung tâm gia sư giỏi 123 với các dịch vụ như:</p>
            <ul>
                <li>
                    Dịch vụ dạy thêm tại nhà: Trung tâm sẽ cho giáo viên có kinh nghiệm đến tận nhà dạy các em học sinh, sinh viên ở tất cả các môn học.</li>
                <li> Dịch vụ dạy tại trung tâm: trung tâm thường xuyên mở các lớp dạy tất cả các môn học từ 1-12. Bên cạnh đó, trung tâm còn mở các lớp luyện thi anh văn chứng chỉ A, B, C, Toeic.</li>
            ...
            <ul>
                ...
                <li> Đào tạo một số kỹ năng học các môn xã hội như lớp học lịch sử bằng phương pháp mới giúp các em học sinh dễ nhớ ngày tháng năm diễn ra các sự kiện lịch sử. Lớp học môn văn không buồn ngủ.</li>
            </ul>
        </div>
        <div class="events">
            ...
            <div class="about-grids">
                ...
                foreach ($tutor->select_four_tutor() as $row) {
                    ...
                    echo $row_img["NAME_IMG"]; ?>" alt="" class="img-responsive" />
                                <figcaption>
