            ...
            <div class="container"> 
                <div class="header-top-left">
                    <ul>
                        ...
                        <li><h4><span class="glyphicon glyphicon-envelope" aria-hidden="true" style="font-size: 22px;">&nbsptanduoc13@gmail.com</span> </h4></li>
                    </ul>
                </div>		
            ...
            <div class="collapse navbar-collapse nav-wil" id="bs-example-navbar-collapse-1">
                <nav>
                    <ul class="nav navbar-nav">
                        ...
                        <li <?php menu_dangnhap($p); ?>><a href="login.php" class="hvr-bounce-to-bottom">Đăng Nhập</a></li>
                    </ul>
                </nav>
            </div>
            <!-- /.navbar-collapse -->
