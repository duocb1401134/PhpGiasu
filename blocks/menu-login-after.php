            ...
            <div class="container">
                <div class="header-top-left">
                    <ul>
                        ...
                        <li><h4><span class="glyphicon glyphicon-envelope" aria-hidden="true" style="font-size: 22px;"> &nbsp tanduoc13@gmail.com</span> </h4></li>
                    </ul>
                </div>
                                ...
                                <a href="#" style="padding:10px 10px 10px 10px "
                                   ...
                                   data-toggle="dropdown" aria-controls="myTabDrop1-contents">
                                    <img style="width: 50px; height: 50px; border-radius: 50%;"
                                         src="<?php
                                         echo $_SESSION["NAME_IMG"];
                                         ?>"/></a>
                                <ul class="dropdown-menu" role="menu" aria-labelledby="myTabDrop1" id="myTabDrop1-contents">
                                    <?php
                                    if ($_SESSION["ADMIN"] == 1) {
                                        echo
                                        "<li><a href='user/index.php?admin=6' class='hvr-bounce-to-bottom' tabindex='-1' role='tab' id='dropdown1-tab'>Admin</a></li>";
                                    }
                                    ?>
                                    <li><a href="user/index.php" class="hvr-bounce-to-bottom" tabindex="-1" role="tab" id="dropdown1-tab" >Profile</a></li>                                    
                                    <li><a href="index.php?dangxuat=1"  class="hvr-bounce-to-bottom" tabindex="-1" role="tab" id="dropdown1-tab" >Đăng xuất</a></li>
                                </ul>
                            </li>
                        </ul>
                    </nav>
